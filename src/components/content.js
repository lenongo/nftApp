...
<<<<<<< HEAD
              ...
              <p>さあ、皆さんで文明を発展させ、世界の謎を解き明かしましょう！</p>
=======
              <p>
                この世界はたくさんの文明に分かれています。
              </p>
              <p>
                すでに体現しているのは、月・雲・波の属性です。
              </p>
              <p>
                彼ら、彼女らは属性ごとにある１人のアーキテクト（クリエイター）から生み出されているのです。
              </p>
              <p>
                皆さんも今日からこの世界の一員です。
              </p>
              <p>
                さあ、皆さんで文明を発展させ、世界の謎を解き明かしましょう！
              </p>
